            ...
            <form action="{{ route('nhanvien.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group1">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control text-box single-line" id="name" name="name" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group1">
                        ...
                        <div class="col-md-8">
                            <input type="email" class="form-control text-box single-line" id="email" name="email" required>
                        </div>
                    </div>
