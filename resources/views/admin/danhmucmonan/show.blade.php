...
@section('content_admin')
    ...
    <div class="checkform">
        <div class="content">
            <h3>CẬP NHÂT DANH MỤC</h3>
            <form action="{{ route('danhmucmonan.update', [$data->id]) }}" method="post">
                @method('PUT')
                @csrf
                <div class="form-horizontal">
                    <hr />
                    <div class="form-group1">
                        <label for="id" class="control-label col-md-5"><b>Mã danh mục: </b></label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group1">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control text-box single-line" value="{{ $data->tendm }}"
                                id="tendm" name="tendm">
                        </div>
                    </div>
